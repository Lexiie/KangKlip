export const metadata = {
  title: "About | KangKlip",
  description: "Learn about KangKlip, the fast short-form clip engine.",
};
      ...
      <section className="reveal stagger-2 border-y border-white/20 py-12">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-4">
            ...
            <h1 className="text-3xl font-display text-white sm:text-4xl">
              Built for fast, clean short-form edits.
            </h1>
            <p className="text-sm text-white/60 sm:text-base">
              KangKlip turns long videos into scroll-stopping shorts with automatic highlights,
              clean cuts, and vertical framing.
            </p>
          </div>
          <div className="space-y-3 text-sm text-white/60">
            <p>
              The focus is simple: speed, consistency, and predictable results. You paste a link,
              choose a duration, and get a batch of clips ready for posting.
            </p>
            <p>
              No account required. Connect a wallet when you want to top up credits and unlock full
              exports.
            </p>
          </div>
        </div>
      ...
      <section className="reveal stagger-3">
        <div className="grid gap-4 sm:grid-cols-2">
          {[
            {
              title: "What you get",
              body: "Hook detection, tight trims, vertical crops, and caption-ready outputs so you can post faster.",
            },
            {
              title: "How it feels",
              body: "One GPU job per request. You always know when a render is running and when the clips are ready.",
            },
          ].map((item) => (
            <div key={item.title} className="border border-white/15 bg-black/60 p-4">
