...
// Render the clip generation builder page.
      ...
      <section id="builder" className="reveal stagger-2 border-y border-white/20 py-12">
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="lg:border-l lg:border-white/20 lg:pl-8">
            <div className="space-y-3">
              <h2 className="text-2xl font-display tracking-wide text-white">Paste your video URL</h2>
              <p className="text-sm text-white/60">Choose duration and clip count.</p>
            </div>
            ...
            <div className="mt-8 border border-white/40 bg-black/80 p-6">
              <label className="grid gap-2 text-xs font-normal uppercase tracking-[0.2em] text-white/55">
                ...
                <input
                  ...
                  disabled={loading}
                />
                <span className="text-[11px] text-white/45">Supports YouTube and direct links.</span>
              </label>
              ...
              <p className="mt-3 text-xs text-white/55">Runs as a single GPU job.</p>
            </div>
          </div>
        </div>
      </section>
